...
class User extends CI_Controller {
    ...
    {       
        ...
        $column_order = array('row_id', 'user_name','full_name','role'); 
        $column_search = array('user_name','full_name','role'); 
        $order = array('row_id' => 'desc'); 
        $custom_search = array('user_name','full_name','role'); 
        $list = $this->datatables->getDatatables($table, $column_order, $column_search, $order, $custom_search, $condition);
        $data = array();
        $no = $_POST['start'];
        foreach ($list as $get) {
			$link = '
